Кидаю готовый вариант `README.md`, где уже учтены:

* Спринт 10 — текущий функционал (как у тебя, только чуть структурировал).
* Спринт 11 — проектирование БД, ER-диаграмма + SQL и примеры запросов.

Можешь просто заменить свой `README.md` на этот и подправить пути к файлам картинки/SQL, если захочешь другие.
